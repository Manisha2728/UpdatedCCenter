...
$(document).ready(function () {
    ...
    var i = $('#id_documentsearchlivefeedsproperties_set-0-frequency_mode').val();
    ...
    $('#id_documentsearchlivefeedsproperties_set-0-frequency_mode').bind('change', function (event) {
